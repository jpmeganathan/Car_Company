class MechanicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mechanic.save
        format.html { redirect_to mechanics_url, notice: 'Mechanic was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @mechanic.update(mechanic_params)
        format.html { redirect_to mechanics_url, notice: 'Mechanic was successfully updated.' }
  ...
  private
    ...
    def mechanic_params
      params.require(:mechanic).permit(:machanic_id, :first_name, :last_name, :address, :Phone_number)
    end
end
